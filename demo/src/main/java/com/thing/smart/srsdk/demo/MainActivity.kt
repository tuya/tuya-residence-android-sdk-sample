package com.thing.smart.srsdk.demo
...
import com.thing.smart.srsdk.demo.access.*
import com.tuya.smart.android.common.utils.L
import com.tuya.smart.android.network.Business
import com.tuya.smart.android.network.http.BusinessResponse
import com.tuya.smart.android.user.api.ILogoutCallback
import com.thing.smart.srsdk.demo.pater.R
import com.tuya.smart.srsdk.api.site.bean.SiteBean
import com.thing.smart.srsdk.demo.personal.PersonalManagerActivity
import com.thing.smart.srsdk.demo.site.*
...
@Composable
fun TextItem(text: String, bottomLine: Boolean = false, value: MutableState<String> , onClick: () -> Unit) {
    Row(
        modifier = rowModifier
            .clickable(onClick = onClick),
        verticalAlignment = Alignment.CenterVertically,
        ...
        Text(text, fontSize = 16.sp, modifier = Modifier.weight(1.0F, true))
        Text(value.value, fontSize = 14.sp)
        ArrowImage()
    }
    if (bottomLine) {
        RowSpaceLine()
...
fun CurrentSite() {
    ...
    TextItem(text = "Current Site", bottomLine = true, Global.siteName) {
