...
import com.tuya.smart.srsdk.sdk.site.fetcher.isOrdinarySite
...
private fun AddAppAccessView(viewModel: DeviceModel = viewModel()) {
    ...
    Box(modifier = Modifier.fillMaxSize()){
        Column(
            ...
            if (Global.currentSite?.isOrdinarySite() == true) {
                Row(
                    modifier = Modifier
                        .fillMaxWidth()
                        ...
                        .addAppAccess(
                            ...
                            object : Business.ResultListener<Boolean> {
                                override fun onFailure(
                                    ...
                                    Toast.makeText(context, p0?.errorMsg, Toast.LENGTH_SHORT)
                                        .show()
                                }
